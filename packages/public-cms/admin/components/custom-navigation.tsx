...
export function CustomNavigation({
  ...
  const ScrollableThreeModel = lists[lists.length - 2]
  const PuzzlePhotoInfra = lists[lists.length - 1]

  return (
    <NavigationContainer authenticatedItem={authenticatedItem}>
      <NavItem href="/">Dashboard</NavItem>
      <NavItem href="/iframe/landing">介紹</NavItem>
      <ListNavItems lists={lists.slice(0, lists.length - 2)} />
      ...
      <ListNavItems lists={[PuzzlePhotoInfra]} />
    </NavigationContainer>
  )
}
